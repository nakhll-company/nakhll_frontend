...
function MegaMenuDesktop(props) {
  return (
    <ul className={styles.nav_list}>
          ...
          <div className={styles.nav_cols_holder}>
            <div className={styles.nav_submenu_col}>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-lamps-and-lights">لامپ و چراغ</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-washing-machine">ماشین لباسشویی</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-sewing-machine">چرخ خیاطی</a>
                </li>
                <li>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-microwave">مایکروویو، مایکروفر</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-espresso-maker">اسپرسو ساز</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-electric-samovars">سماور برقی</a>
                </li>
                <li>
                  <a href="/search/category-electric-kettle">کتری برقی</a>
                </li>
                <li>
                  <a href="/search/category-coffee-maker">قهوه ساز</a>
                </li>
                <li>
                  <a href="/search/category-citrus-juice">آب مرکبات گیر</a>
                </li>
              </ul>
              <ul className={styles.nav_submenu_cat}>
                <li className={styles.nav_submenu_col_title}>
                ...
                <li>
                  <a href="/search/category-hand-blender">گوشت کوب برقی</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-kitchen-machine">ماشین آشپزخانه</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-dinnerware-set">سرویس غذاخوری</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-servingware">ظروف پذیرایی</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-tissue-paper">دستمال کاغذی</a>
                </li>
                <li>
                  <a href="/search/category-washing-liquid">مایع دستشویی</a>
                </li>
                <li>
                  <a href="/search/category-clothes-detergents">شوینده لباس</a>
                </li>
                <li>
                  <a href="/search/category-dishes-detergents">شوینده ظروف</a>
                </li>
                <li>
                  <a href="/search/category-surface-cleaner">شوینده سطوح</a>
                </li>
                <li>
                  <a href="/search/category-shoe-cleaning">نظافت کفش</a>
                </li>
                <li>
                  <a href="/search/category-cleaning-tools">ابزار نظافت</a>
                </li>
                <li>
                  <a href="/search/category-insecticide">حشره کش و سوسک کش</a>
                </li>
                <li>
                  <a href="/search/category-clothes-pin">گیره لباس</a>
                </li>
                <li>
                  <a href="/search/category-laundry-basket">سبد رخت چرک</a>
                </li>
                <li>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-home-furniture">مبلمان خانگی</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-pictorial-carpet">تابلو فرش</a>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className={styles.nav_cols_holder}>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-welding-machine">دستگاه جوش</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-versatile-tool">ابزار همه کاره </a>
                </li>
                <li>
                  <a href="/search/category-electric-engine">موتور برق</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-valves">شیرآلات و دوش حمام</a>
                </li>
                <li>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-decorative-lights">لوسترو آباژور</a>
                </li>
                <li>
                  <a href="/search/category-power-strip-and-voltage-protector">
                    چندراهی برق و مبدل
            ...
            <div className={styles.nav_submenu_col}>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-steering-wheel-cover">روکش فرمان</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-helmets">کلاه کاسکت موتور</a>
                </li>
              </ul>
              <ul className={styles.nav_submenu_cat}>
                <li className={styles.nav_submenu_col_title}>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-car-brake-pads">لنت ترمز خودرو</a>
                </li>
                <li>
      ...
      <li className={styles.nav_item}>
        <a className={styles.nav_item_link} href="/search/category-stationery">
          ...
          <div className={styles.nav_cols_holder}>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-book-and-art-business">کسب و کار</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-book-and-art-general">عمومی</a>
                </li>
                <li>
                  <a href="/search/category-book-and-art-artistic">هنر</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-book-and-art-historical">تاریخ</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-book-and-art-philosophy">فلسفه</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-book-and-art-politics">سیاست</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-book-and-art-social">اجتماعی</a>
                </li>
                <li>
                  <a href="/search/category-book-and-art-legal">حقوق</a>
                </li>
                <li>
                  <a href="/search/category-book-and-art-computer">کامپیوتر</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-notebook-and-paper">کاغذ و دفتر</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-schoolbag-backpack">کیف و کوله </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-calendar">تقویم و سالنامه</a>
                </li>
                <li>
                  <a href="/search/category-glue">زونکن،چسب و لوازم اداری</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-english-learning">آموزش زبان</a>
                </li>
                <li>
                  <a href="/search/category-music-training">آموزش موسیقی</a>
                </li>
                <li>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-security-software">آنتی ویروس</a>
                </li>
                <li>
                  <a href="/search/category-operating-system">سیستم عامل</a>
                </li>
                <li>
          ...
          <div className={styles.nav_cols_holder}>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-cosmetic-equipment">ابزار آرایش</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-skin-care">کرم و مراقبت پوست</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-oral-care">بهداشت دهان و دندان</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-womens-health">بهداشت بانوان</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-hairclipper">ماشین اصلاح صورت</a>
                </li>
                <li>
                  <a href="/search/category-hairclipper">ماشین اصلاح سر</a>
                </li>
                <li>
                  <a href="/search/category-ironing-and-styling">اتو مو </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-electric-toothbrush">مسواک برقی</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-blood-glucose-test">تست قند خون</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-foot-care-tools">ابزار مراقبت پا</a>
                </li>
                <li>
          ...
          <div className={styles.nav_cols_holder}>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-sugar-and-candy">قند و نبات</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-syrup-and-juice">شربت و آبمیوه</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-non-alcoholic-beer">ماءالشعیر</a>
                </li>
                <li>
                  <a href="/search/category-energy-drink">نوشابه انرژی زا</a>
                </li>
                <li>
                  <a href="/search/category-sweats-and-roses">عرقیات و گلاب</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-biscuits-and-wafers">بیسکویت</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-puffs-and-snacks">پفک و اسنک</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-chewing-gum-and-mouthwash">آدامس</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-cakes-and-cookies">کیک و کلوچه</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-breakfast-cereal">غلات صبحانه</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-peanut-butter">کره بادام زمینی</a>
                </li>
              </ul>
              <ul className={styles.nav_submenu_cat}>
                <li className={styles.nav_submenu_col_title}>
          ...
          <div className={styles.nav_cols_holder}>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-intellectual-game">بازی فکری</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-swings-and-slides">تاب و سرسره</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-puzzle-and-building">پازل و لگو</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-robots-and-gadget">ربات و گجت</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-play-gym">تشک بازی و پارک بازی</a>
                </li>
                <li>
                  <a href="/search/category-rattles">جغجغه</a>
                </li>
                <li>
                  <a href="/search/category-baby-walkers">روروک و واکر</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-pedal-horse">اسب رکاب‌دار</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-baby-and-infant-shampoo">شامپو</a>
                </li>
                <li>
                  <a href="/search/category-baby-wet-wipes">دستمال مرطوب</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-baby-bath-tub">وان حمام نوزاد</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-children-cotton-swab">گوش پاک کن</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-baby-and-infant-milking">شیردوش</a>
                </li>
              </ul>
              <ul className={styles.nav_submenu_cat}>
                <li className={styles.nav_submenu_col_title}>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-hot-water-bag">پد و کیسه آب گرم</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-feeding-cloak">کاور شیردهی</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-feeding-pillow">بالش شیردهی</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-baby-blanket">پتو کودک و نوزاد</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-baby-and-infant-cradle">گهواره</a>
                </li>
                <li>
                  <a href="/search/category-mosquito-net">پشه بند</a>
                </li>
                <li>
                  <a href="/search/category-baby-bed">تختخواب کودک و نوزاد</a>
                </li>
                <li>
          ...
          <div className={styles.nav_cols_holder}>
            <div className={styles.nav_submenu_col}>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-skate-and-skateboard">اسکیت </a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-pingpong-table">میز پینگ پنگ</a>
                </li>
                <li>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-water-sports">ورزش های آبی</a>
                </li>
                <li>
                  <a href="/search/category-martialarts">ورزش های رزمی</a>
                </li>
                <li>
                  <a href="/search/category-mindsport"> ورزش های فکری</a>
                </li>
                <li>
                  <a href="/search/category-archery">ورزش های نشانه‌ گیری</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-diving-equipment">لوازم غواصی</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-bag-and-backpack">کیف و کوله</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-fishing-tools">لوازم ماهیگیری</a>
                </li>
              </ul>
              <ul className={styles.nav_submenu_cat}>
                <li className={styles.nav_submenu_col_title}>
      ...
      <li className={styles.nav_item}>
        <a className={styles.nav_item_link} href="/search/category-apparel">
          ...
          <div className={styles.nav_cols_holder}>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-womens-gold-pendant">آویز طلا </a>
                </li>
                <li>
                  <a href="/search/category-womens-gold-binding">پابند طلا</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-womens-gold-brooch">گل سینه طلا </a>
                </li>
                <li>
                  <a href="/search/category-womens-gold-chains">زنجیر طلا</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-womens-gold-ring">انگشتر طلا </a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-bullion">شمش و پلاک طلا و نقره</a>
                </li>
              </ul>
            </div>
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-mens-backpack">کوله پشتی مردانه</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-men-wallet">کیف پول مردانه</a>
                </li>
                <li>
                  <a href="/search/category-mens-gift-set">ست هدیه مردانه</a>
                </li>
                <li>
                  <a href="/search/category-mens-gloves">دستکش مردانه</a>
                </li>
                <li>
                  <a href="/search/category-men-headwear">سرپوش مردانه</a>
                </li>
                <li>
                  <a href="/search/category-men-jewelry">زیورآلات مردانه</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-men-ties">کراوات و پاپیون مردانه</a>
                </li>
                <li>
                  <a href="/search/category-mens-keychain">جاکلیدی مردانه</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-women-backpack">کوله پشتی زنانه</a>
                </li>
                <li>
                  <a href="/search/category-women-bag">کیف زنانه</a>
                </li>
                <li>
                  <a href="/search/category-womens-belt">کمربند زنانه</a>
                </li>
                <li>
                  <a href="/search/category-womens-gift-set">ست هدیه زنانه</a>
                </li>
                <li>
                  <a href="/search/category-womens-gloves">دستکش زنانه</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-uni-headwear">سرپوش زنانه</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-circle-budgets">پیکسل زنانه</a>
                </li>
                <li>
            ...
            <div className={styles.nav_submenu_col}>
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-men-sportswear">پوشاک ورزشی</a>
                </li>
              </ul>
              <ul className={styles.nav_submenu_cat}>
                <li className={styles.nav_submenu_col_title}>
                ...
                <li>
                  <a href="/search/category-casual-shoes-for-men">کفش روزمره</a>
                </li>
                <li>
              ...
              <ul className={styles.nav_submenu_cat}>
                ...
                <li>
                  <a href="/search/category-women-mantou-and-pant">مانتو</a>
                </li>
                <li>
                  <a href="/search/category-women-shirts">بلوز و شومیز</a>
                </li>
                <li>
                ...
                <li>
                  <a href="/search/category-women-mantou-and-pant">شلوار</a>
                </li>
                <li>
                  <a href="/search/category-women-underwear">لباس زیر</a>
                </li>
                <li>
                  <a href="/search/category-women-sportwear">پوشاک ورزشی</a>
                </li>
              </ul>
              <ul className={styles.nav_submenu_cat}>
                <li className={styles.nav_submenu_col_title}>
                ...
                <li>
                  <a href="/search/category-women-sneakers">کفش ورزشی</a>
                </li>
              </ul>
              <ul className={styles.nav_submenu_cat}>
                <li className={styles.nav_submenu_col_title}>
