          ...
          <>
            <div className={`${styles.list_items} my-3`}>
              ...
              <div className={`${styles.images} p-3`}>
                ...
                <span>
                  {jsonAddress.state &&
                    `${jsonAddress.state} | ${jsonAddress.big_city} | ${jsonAddress.city} | ${jsonAddress.address}`}
                </span>
              </div>
            ...
            {detailData.items.length > 0 &&
              detailData.items.map((value, index) => (
                <div className={styles.list_items} key={index}>
                  ...
                  <div className={`${styles.images} p-3`}>
                    ...
                    <div className="d-flex align-items-center">
                      <Link
                        href={`/shop/${value.shop_slug}/product/${value.slug}`}
                      >
                        <a>
                          {value.image && (
                            <Image
                  ...
                  <div className={`${styles.detail} p-3`}>
                    <div className="d-flex justify-content-center">
                      <div className="d-flex flex-column">
                        <Image
                          src={
                            detailData.status === "wait_store_approv"
                              ? "/orderDetial/tik_black.svg"
                              : "/orderDetial/tik.svg"
                          }
                          alt=""
                          width="30"
                      ...
                      <div className="d-flex flex-column">
                        <Image
                          src={
                            detailData.status === "wait_store_checkout" ||
                            detailData.status === "completed" ||
                            detailData.status === "wait_customer_approv"
                              ? "/orderDetial/tik.svg"
                              : "/orderDetial/tik_black.svg"
                          }
                          alt=""
                    ...
                    <div className="d-flex flex-column align-items-center mt-4">
                      ...
                      <br />
                      <Link
                        href={`https://tracking.post.ir/?id=${value.barcode}`}
                      >
                        <a
                          target="_blank"
                          style={{
