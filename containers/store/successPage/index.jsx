...
export default function SuccessPage() {
  return (
    <div className={styles.wrapper}>
      ...
      <p className={styles.suggesstion_text}>
        برای بهتر دیده شدن حجره می توانید از طریق
        <br />
        دکمه زیر محصول خود را ثبت دهید.
      </p>
      <div className={styles.wrapper_links}>
        <Link href={`/fp/product/create`}>
          <a className={styles.link_create_product}>ثبت محصول</a>
        </Link>
        <Link href={`/fp`}>
