    ...
    <div className={styles.wrapper}>
      ...
      <footer>
        ...
        <div className={styles.wrapper_button}>
          <Link
            href={
              Object.keys(userLogin).length > 0 ? "/fp/store/create/" : "/login"
            }
          >
            <a className={styles.button_solid}>حجره خودتو بساز</a>
          </Link>
          <Link href="https://nakhll.com/blog/%d9%be%d8%a7%d8%b3%d8%ae-%d8%b3%d9%88%d8%a7%d9%84%d8%a7%d8%aa-%d9%be%d8%b1%d8%aa%da%a9%d8%b1%d8%a7%d8%b1-%d9%86%d8%ae%d9%84/">
            <a className={styles.button_empty}>سوالات متداول</a>
          </Link>
        </div>
      </footer>
    </div>
