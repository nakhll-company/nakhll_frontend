    ...
    return (
        <>
            ...
            <div className={`container-fluid ${styles.main_wrapper}`}>
                <div className="row">
                    <div className={`col-md-4 col-lg-3 d-none d-md-block ${styles.right_menu}`}>
                        <ul>
                    ...
                    {width < breakpoint &&
                        <div className={styles.menu_mobile}>
                            <ul className="d-flex justify-content-between align-items-center">
                                ...
                                <li onClick={(event) => { activeLink(event) }}>
                                    <Link href="/fp">
                                ...
                                <li className="d-flex flex-column align-items-center" onClick={(event) => {
                                    activeLink(event);
                                    setProfilePages((pre) => {
                                        return {
                                            editProfile: false,
                                    ...
                                    <i className="fas fa-box-open"></i><br />
                                    <span>سفارشات</span>
                                </li>
                                <li className="d-flex flex-column align-items-center ms-4" onClick={(event) => {
                                    activeLink(event);
                                    setProfilePages((pre) => {
                                        return {
                                            editProfile: false,
                                    ...
                                    <i className="far fa-bookmark"></i><br />
