        ...
        <>
            ...
            <div className="d-flex flex-column justify-content-center col-12 col-md-8 col-lg-5 m-auto bg-white p-5 mt-5 shadow-lg rounded">
                ...
                <form onSubmit={handleSubmit(submit)}>
                    <label htmlFor="mobile" className="mb-2" style={{ fontSize: "15px" }}>شماره موبایل خود را وارد کنید</label>
                    <input type="number" id="mobile" className="form-control mb-2" placeholder="مثال : *******0913"
                        {...register("mobile", {
