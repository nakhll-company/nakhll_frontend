...
const UpdateAddress = () => {
  ...
  return (
    <>
      ...
      {loading ? (
        <div
          className={`col-12 col-lg-5 py-5 ${styles.wrapper}`}
        ...
        <div className={`col-12 col-lg-5 ${styles.wrapper}`}>
          <header className={styles.header}>
            <Link
              href={
                prev
                  ? `/cart/payment?invoice_id=${invoice_id}`
                  : `/cart/address?invoice_id=${invoice_id}`
              }
            >
              ...
              <div className={styles.form_row}>
                ...
                <div className={`${styles.form_group} col-md-6 col-sm-12`}>
                  ...
                  <input
                    type="text"
                    className="form-control"
                    {...register("receiver_mobile_number", { required: true })}
                  />
