            ...
            {(userInfo && userInfo.user && userInfo.user.first_name && userInfo.user.last_name) ?
                <form className={styles.form} onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className={styles.form_left}>
                        <p>
                            نام حجره خود را به زبان فارسی انتخاب کنید.<br />
                            نام حجره باید مختص شما و جز مالکیت شخص دیگری نباشد.<br />
                            سعی شود تا نام نامناسب و بیگانه استفاده نشود.<br />
                            این نام هویت و شخصیت شماست و برای کاربران نمایش داده می شود.
                        </p>
                    </div>
                </form> :
