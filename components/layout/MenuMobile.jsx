    ...
    <div className={styles.menu_mobile}>
        ...
        <a>
          <span
            className={`${styles.menu_card_item_menu} ${
              router.pathname === "/fp/product" && styles.active
            }`}
            onClick={() => {
      ...
      >
        <a>
          <span
            className={`${styles.menu_card_item_menu} ${
              router.pathname === "/fp/order/completed" && styles.active
            }`}
            onClick={() => {
              document.querySelector("#moreOptions").style.display = "none";
            }}
      ...
      <Link className="menu-card-item-menu" href="/fp" passHref={true}>
        <a>
          <span
            className={`${styles.menu_card_item_menu} ${
              router.pathname === "/fp" && styles.active
            }`}
            onClick={() => {
              document.querySelector("#moreOptions").style.display = "none";
            }}
      ...
      <Link className="menu-card-item-menu" href="/fp/setting" passHref={true}>
        <a>
          <span
            className={`${styles.menu_card_item_menu} ${
              router.pathname === "/fp/setting" && styles.active
            }`}
            onClick={() => {
              document.querySelector("#moreOptions").style.display = "none";
            }}
      ...
      <span
        className={`${styles.menu_card_item_menu} ${
          router.pathname === "/fp/options" && styles.active
        }`}
        onClick={() => {
