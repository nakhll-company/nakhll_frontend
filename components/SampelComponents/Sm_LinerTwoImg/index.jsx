    ...
    <div className={styles.wrap}>
      <div className={styles.right}>
        <label htmlFor="firstImageLinerTwo">
          <img src={croppedImage ? croppedImage : "/image/sample/main.jpg"} alt="banner one" />
          <input type="file" name="firstImageLinerTwo" id="firstImageLinerTwo" onChange={(e) => { selectImage(e, setImageSrc, setShowModal) }} accept="image/*" style={{ visibility: "hidden" }} />
        </label>
      ...
      <div className={styles.left}>
        <label htmlFor="secondImageLinerTwo">
          ...
          <input type="file" name="secondImageLinerTwo" id="secondImageLinerTwo" style={{ visibility: "hidden" }} />
        </label>
      </div>
    </div>
  );
