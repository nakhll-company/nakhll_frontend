          ...
          <div className={styles.mobile_menu}>
            ...
            <div className={styles.top_menu}>
              <div className="btn_links">
                <a className="btn_link_box" href="/cart">
                ...
                <a className="btn_link_box" href="/help">
                  <div className="icon_holder">
                    <img
                ...
                <a className="btn_link_box" href="/page/shahneshin">
                  <div className="icon_holder">
                    <img
                ...
                <a className="btn_link_box" href="/landing/seller">
                  <div className="icon_holder">
                    <img
              ...
              <h2 className="title_menu">دسته بندی محصولات</h2>
            </div>
            <ul>
              <li>
                <a href="javascript:void(0);">
                  کالای دیجیتال<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  ...
                  <li>
                    <a>
                      موبایل <i className="icon icon-Down"></i>
                    </a>
                  ...
                  <li>
                    <a>
                      لوازم جانبی موبایل <i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      لپتاپ <i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      لوازم جانبی لپ تاپ <i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      تجهیزات ذخیره‌سازی اطلاعات<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="/search/category-speaker">
                      اسپیکر<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="/search/category-network">
                      مودم <i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      کامپیوتر و تجهیزات جانبی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      کنسول بازی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      تلویزیون<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="/search/category-usb-digital-tv-receiver">
                      گیرنده دیجیتال تلویزیون<i className="icon icon-Left"></i>
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0);">
                      دوربین<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      لوازم جانبی دوربین<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      ماشین های اداری<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
              ...
              <li>
                <a href="javascript:void(0);" title="">
                  خانه و آشپزخانه<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      نور و روشنایی <i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      لوازم خانگی برقی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      لوازم پخت و پز برقی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      نوشیدنی ساز<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      غذاساز و خرد کن<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      سرو و پذیرایی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      آشپزخانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      خواب و حمام<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      شستشو و نظافت<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      دکوراتیو<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
              ...
              <li>
                <a title="">
                  خودرو، ابزار، باغبانی<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  <li>
                  ...
                  <li>
                    <a>
                      ابزار برقی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      ابزار دستی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      ابزار غیر برقی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لوازم باغبانی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لوازم و یراق آلات ساختمان<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      روشنایی و لوازم الکتریکی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      موتور سیکلت<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لوازم مصرفی خودرو<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لوازم جانبی خودرو<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لوازم یدکی خودرو<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
              ...
              <li>
                <a title="">
                  لوازم‌التحریر، کتاب و هنر<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  <li>
                  ...
                  <li>
                    <a>
                      کتاب چاپی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لوازم تحریر<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      محتوای آموزشی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      نرم افزار<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      آلات موسیقی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      صنایع دستی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
              ...
              <li>
                <a title="">
                  آرایشی و سلامت<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      لوازم بهداشتی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      لوازم آرایشی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      عطر و ادکلن<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      لوازم شخصی برقی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      ابزار سلامت<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
              ...
              <li>
                <a href="javascript:void(0);" title="">
                  خوار و بار<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      نوشیدنی ها<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a title="">
                      دسر و شیرینی پزی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      آجیل و خشکبار<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a title="">
                      کنسرو و غذای آماده<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      تنقلات<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      صبحانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      لبنیات<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
                  ...
                  <li>
                    <a href="javascript:void(0);" title="">
                      پروتئینی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="inner_submenu">
                      <li>
              ...
              <li>
                <a title="">
                  اسباب بازی، کودک و نوزاد<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  <li>
                  ...
                  <li>
                    <a>
                      اسباب بازی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      پوشاک و کفش کودک و نوزاد<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      بهداشت کودک<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لوازم شخصی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      گردش و سفر<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      ایمنی و مراقبت<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      غذاخوری<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      خواب کودک<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
              ...
              <li>
                <a>
                  ورزش و سفر و کمپینگ<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  <li>
                  ...
                  <li>
                    <a>
                      ورزش های هوازی و بدنسازی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      ورزش های سرعتی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      ورزش های توپی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      سایر وسایل ورزشی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      کوه‌نوردی و کمپینگ<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      تجهیزات سفر<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                        <a href="/search/category-bag-and-backpack">
                  ...
                  <li>
                    <a>
                      دوچرخه و لوازم جانبی<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
              ...
              <li>
                <a>
                  طلا، مد و پوشاک<i className="icon icon-Down"></i>
                </a>
                <ul className="submenu">
                  <li>
                  ...
                  <li>
                    <a>
                      زیورآلات طلا زنانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      اکسسوری مردانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      اکسسوری زنانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      ساعت مردانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      ساعت زنانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لباس مردانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      کفش مردانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      لباس زنانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      کفش زنانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
                  ...
                  <li>
                    <a>
                      بچه گانه<i className="icon icon-Down"></i>
                    </a>
                    <ul className="submenu">
                      <li>
