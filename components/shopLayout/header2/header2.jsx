...
function Header2(props) {
  return (
    <>
          ...
          <div className={styles.top_header}>
            ...
            <div className={styles.top_header_leftside}>
              <div className={styles.be_seller}>
                <a href="/landing/seller">در تیمچه بفروش!</a>
              </div>
              ...
              <div className={styles.help_link}>
                <a title="راهنمای تیمچه" href="/help">
              ...
              <ul className={styles.nav_list}>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-mobile-accessories">
                              لوازم جانبی موبایل<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          ...
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-smart-watch-and-smartband">
                              مچبند و ساعت هوشمند<i className="icon icon-Left"></i>
                            </a>
                          </li>
                        </ul>
                      </div>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-laptop-accessories">
                              لوازم جانبی لپ تاپ<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-headphones-headsets-handsfree">
                              هدفون، هدست، هندزفری<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li className={styles.nav_submenu_col_title}>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-photography-accessories">
                              لوازم جانبی دوربین<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-personal-appliance-accessories">
                              فندک و لوازم جانبی<i className="icon icon-Left"></i>
                            </a>
                          </li>
                        </ul>
                      </div>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-electric-cooking-appliances">
                              لوازم پخت و پز برقی<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-car-consumables">
                              لوازم مصرفی خودرو<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-car-accessories">
                              لوازم جانبی خودرو<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                ...
                <li className={styles.nav_item}>
                  <a className={styles.nav_item_link} href="/search/category-stationery">
                    لوازم‌التحریر، کتاب و هنر<i className="fas fa-angle-down"></i>
                  </a>
                  <div className={`container  ${styles.nav_submenu}`}>
                    <div className={styles.nav_cols_holder}>
                      <div className={styles.nav_submenu_col}>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-canned-and-ready-meals">
                              کنسرو و غذای آماده<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                ...
                <li className={styles.nav_item}>
                  ...
                  >
                    اسباب بازی، کودک و نوزاد<i className="fas fa-angle-down"></i>
                  </a>
                  <div className={`container  ${styles.nav_submenu}`}>
                    <div className={styles.nav_cols_holder}>
                      <div className={styles.nav_submenu_col}>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-mountain-climbing-and-camping">
                              کوه‌نوردی و کمپینگ<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-bicycles-and-accessories">
                              دوچرخه و لوازم جانبی<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
                        ...
                        <ul className={styles.nav_submenu_cat}>
                          <li className={styles.nav_submenu_col_title}>
                            <a href="/search/category-women-gold-jewelry">
                              زیورآلات طلا زنانه<i className="icon icon-Left"></i>
                            </a>
                          </li>
                          <li>
      ...
      <header style={{display:"none"}} className={styles.mobile_header}>
            ...
            <ul>
              ...
              <li>
                ...
                <ul className={styles.submenu}>
                  ...
                  <li>
                    <a>
                      دوچرخه و لوازم جانبی<i className="fas fa-angle-down"></i>
                    </a>
                    <ul className={styles.submenu}>
                      <li>
                        <a href="/search/category-bicycle">دوچرخه</a>
